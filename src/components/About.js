        ...
        <Container id="about" borderRadius="md" maxW="container.xl" py={20}>
          <SlideFadeOnScroll>
            ...
            <Box align="center" borderRadius="md" boxShadow="xl" p={10} pb={20} overflow="hidden">
              <Box pb={10}>
                <Image src={SylvieMemainYeComputer} alt="Sylvie and computer" w={400} height={400} borderRadius="2xl" />
              </Box>

              <Box>
                <Heading textAlign="center" pt="5" fontWeight="bold" fontSize={30}>
              ...
              <Text fontSize={30} mb={5} textColor={"purple.600"} fontWeight="bold" textAlign="center">
                What is the purpose ? 🧐
              </Text>
              <Text fontSize={25} mb={5} textAlign="center">
                ...
                <br />
                <br />
                The goal of this website is to exhibit one of your most beautiful artistic photos in the form of an NFT.
                <br />
              ...
              <Text fontSize={30} mb={5} textColor={"green.600"} textAlign="center" fontWeight="bold">
                What tools will you need? 🛠️
              </Text>
              <Text fontSize={25} mb={5} textAlign="center">
                - A Wallet
                <br />- The link of your picture
              </Text>
            </Box>
          </SlideFadeOnScroll>
        </Container>
